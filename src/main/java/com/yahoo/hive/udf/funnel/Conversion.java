...
@Description(name = "conversion",
             value = "conversion(funnel) - Converts a funnel from raw counts to conversion rates.",
             extended = "Converts absolute count funnel to conversion rates.")
public class Conversion extends GenericUDF {
    static final Log LOG = LogFactory.getLog(Conversion.class.getName());
    ...
    public Object evaluate(DeferredObject[] args) throws HiveException {
        ...
        // Starting from the second element, calculate conversion rate
    ...
    public String getDisplayString(String[] children) {
        return "Converts absolute count funnel to conversion rates.";
    }
}
